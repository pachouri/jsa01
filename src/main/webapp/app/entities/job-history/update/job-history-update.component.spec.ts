  ...
  describe("JobHistory Management Update Component", () => {
    ...
    describe("ngOnInit", () => {
      it("Should call job query and add missing value", () => {
        ...
        jest
          .spyOn(jobService, "query")
          .mockReturnValue(of(new HttpResponse({ body: jobCollection })));
        const expectedCollection: IJob[] = [job, ...jobCollection];
        jest
          .spyOn(jobService, "addJobToCollectionIfMissing")
      ...
      it("Should call department query and add missing value", () => {
        ...
        jest
          ...
          .mockReturnValue(
            of(new HttpResponse({ body: departmentCollection }))
          );
        ...
        ).toHaveBeenCalledWith(departmentCollection, department);
      ...
      it("Should call employee query and add missing value", () => {
        ...
        ).toHaveBeenCalledWith(employeeCollection, employee);
      ...
      it("Should update editForm", () => {
        ...
        expect(comp.editForm.value).toEqual(
          expect.objectContaining(jobHistory)
        );
