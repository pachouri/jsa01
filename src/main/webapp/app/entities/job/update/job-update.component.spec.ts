  ...
  describe("Job Management Update Component", () => {
    ...
    describe("ngOnInit", () => {
      it("Should call Task query and add missing value", () => {
        ...
        jest
          .spyOn(taskService, "query")
          .mockReturnValue(of(new HttpResponse({ body: taskCollection })));
        const additionalTasks = [...tasks];
        const expectedCollection: ITask[] = [
          ...additionalTasks,
          ...taskCollection,
        ];
        jest
          .spyOn(taskService, "addTaskToCollectionIfMissing")
