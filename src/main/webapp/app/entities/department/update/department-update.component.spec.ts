  ...
  describe("Department Management Update Component", () => {
    ...
    describe("ngOnInit", () => {
      it("Should call location query and add missing value", () => {
        ...
        jest
          .spyOn(locationService, "query")
          .mockReturnValue(of(new HttpResponse({ body: locationCollection })));
        const expectedCollection: ILocation[] = [
          location,
          ...locationCollection,
        ];
        jest
          .spyOn(locationService, "addLocationToCollectionIfMissing")
        ...
        expect(
          locationService.addLocationToCollectionIfMissing
        ).toHaveBeenCalledWith(locationCollection, location);
