...
class EmployeeResourceIT {
  ...
  private static final Instant UPDATED_HIRE_DATE = Instant
    .now()
  ...
  void createEmployee() throws Exception {
    ...
    assertThat(testEmployee.getCommissionPct())
      .isEqualTo(DEFAULT_COMMISSION_PCT);
  }
  ...
  void getAllEmployees() throws Exception {
    ...
    restEmployeeMockMvc
      ...
      .andExpect(
        jsonPath("$.[*].id").value(hasItem(employee.getId().intValue()))
      )
  ...
  void getEmployee() throws Exception {
    ...
    restEmployeeMockMvc
      ...
      .andExpect(
        jsonPath("$.commissionPct").value(DEFAULT_COMMISSION_PCT.intValue())
      );
  }
  ...
  void putNewEmployee() throws Exception {
    ...
    assertThat(testEmployee.getCommissionPct())
      .isEqualTo(UPDATED_COMMISSION_PCT);
  }
  ...
  void deleteEmployee() throws Exception {
    ...
    restEmployeeMockMvc
      .perform(
        delete(ENTITY_API_URL_ID, employee.getId())
