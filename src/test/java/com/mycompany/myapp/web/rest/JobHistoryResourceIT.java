...
class JobHistoryResourceIT {
  ...
  private static final Instant UPDATED_START_DATE = Instant
    .now()
    .truncatedTo(ChronoUnit.MILLIS);

  private static final Instant DEFAULT_END_DATE = Instant.ofEpochMilli(0L);
  private static final Instant UPDATED_END_DATE = Instant
    .now()
    .truncatedTo(ChronoUnit.MILLIS);
  ...
  void getAllJobHistories() throws Exception {
    ...
    restJobHistoryMockMvc
      ...
      .andExpect(
        jsonPath("$.[*].id").value(hasItem(jobHistory.getId().intValue()))
      )
      .andExpect(
        jsonPath("$.[*].startDate")
  ...
  void putNewJobHistory() throws Exception {
    ...
    JobHistory updatedJobHistory = jobHistoryRepository
  ...
  void deleteJobHistory() throws Exception {
    ...
    restJobHistoryMockMvc
      .perform(
        delete(ENTITY_API_URL_ID, jobHistory.getId())
