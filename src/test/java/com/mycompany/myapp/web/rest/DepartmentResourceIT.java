...
class DepartmentResourceIT {
  ...
  void createDepartment() throws Exception {
    ...
    assertThat(testDepartment.getDepartmentName())
      .isEqualTo(DEFAULT_DEPARTMENT_NAME);
  }
  ...
  void getAllDepartments() throws Exception {
    ...
    restDepartmentMockMvc
      ...
      .andExpect(
        jsonPath("$.[*].id").value(hasItem(department.getId().intValue()))
      )
      .andExpect(
  ...
  void putNewDepartment() throws Exception {
    ...
    Department updatedDepartment = departmentRepository
    ...
    Department testDepartment = departmentList.get(departmentList.size() - 1);
    assertThat(testDepartment.getDepartmentName())
      .isEqualTo(UPDATED_DEPARTMENT_NAME);
  }
  ...
  void deleteDepartment() throws Exception {
    ...
    restDepartmentMockMvc
      .perform(
        delete(ENTITY_API_URL_ID, department.getId())
